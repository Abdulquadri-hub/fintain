window.onload = function() {
 ...
 let signupDialog = document.querySelector(".signup-dialog");
 let  signupCloseBtn = document.querySelector(".signup-dialog-btn");


async function submitHander() { 
     if(!runSignupValidations()) return
 
     let result = await httpRequest('https://comeandsee.com.ng/kreativerock/admin/controllers/userscript', getSignupFormParams(), document.querySelector('button#submit'));
