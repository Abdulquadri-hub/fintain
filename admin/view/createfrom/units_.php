                    ...
                    <div>
                        ...
                        <div class="flex flex-col divide-y">
                            <div class="py-5">
                                ...
                                <h4 class="font-semibold text-2xl text-default-700" name="smsunits">Loading...</h4>
                            </div>
                            
                            <div class="py-5">
                                <p class="text-xs tracking-wide font-semibold uppercase text-default-700 mb-1">Unit spent</p>
                                <h4 class="font-semibold text-2xl text-default-700" name="smsunitsspent">Loading...</h4>
                            </div>
                        </div>
