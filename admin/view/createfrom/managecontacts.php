        ...
        <div>
            <div class="flex justify-between gap-3 pb-5">
                ...
                <div class="flex gap-1">
                        ...
                        <select type="text" class="form-inputs w-[250px]" data-toggle="input-mask" name="segment_id" id="segment">
            ...
            <div class="flex justify-end gap-5 items-center mt-3">
                <span class="text-blue-600 capitalize">select contact and update their segment</span> 
                <div class="flex flex-col gap-1">
                    <label class="text-default-800 text-sm font-medium inline-block hidden">Segment</label>
                    <select type="text" class="form-inputs w-[150px]" data-toggle="input-mask" name="segment_id" id="segment3">
                        <option value="">Select Segment</option>
                    </select>
                </div>
        ...
        <div class="px-5 py-16">
            ...
            <div class="my-5">
                <form id="contactform" class="flex flex-col gap-3">
                    ...
                    <div class="flex flex-col gap-1">
                        <label class="text-default-800 text-sm font-medium inline-block">Segment</label>
                        <select type="text" class="form-input" data-toggle="input-mask" placeholder="(234) xxx-xxx-xxxx" name="segment" id="segment2">
                            <option value="">Select Segment</option>
                        </select>
                    </div>
                </form>
