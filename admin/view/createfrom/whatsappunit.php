<div>
    <div class="mx-auto lg:w-4/5 2xl:w-3/5">
        ...
        <div class="mb-10 flex gap-5 lg:flex-row lg:justify-between flex-col">
            <div>
                <h4 class="text-default-900 text-2xl font-semibold capitalize">Purchase Whatsapp Units</h4>
                <p class="text-default-500 mt-1">This is your units center. Whatsapp unit to be spent for your rcs messaging must be purchased first</p>
            </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-col divide-y">
                            <div class="py-5">
                                ...
                                <h4 class="font-semibold text-2xl text-default-700" name="whatsappunits">Loading...</h4>
                            </div>
                            
                            <div class="py-5">
                                <p class="text-xs tracking-wide font-semibold uppercase text-default-700 mb-1">Unit spent</p>
                                <h4 class="font-semibold text-2xl text-default-700" name="whatsappunitsspent">Loading...</h4>
                            </div>
                        </div>
...
<div id="overlay-right" class="[--overlay-backdrop:static] hs-overlay overflow-hidden hs-overlay-open:translate-x-0 translate-x-full fixed top-0 right-0 transition-all duration-300 transform h-full max-w-md w-full z-70 bg-white border-s border-default-200 hidden"
    ...
    <div class="relative overflow-y-auto h-full"> 
        ...
        <form id="whatsappform" class="px-5 py-16">
            <div class="flex flex-col gap-3">
                <div class="flex flex-col gap-1">
                    <label class="text-default-800 text-sm font-medium inline-block">Whatsapp package</label>
                    <select type="text" class="form-input" name="whatsapppackageid" id="whatsapppackageid">
                        <option value="" selected=""> -- Select Package -- </option>
                    </select>
                </div>
                <div class="flex flex-col gap-1">
                    <label class="text-default-800 text-sm font-medium inline-block">Cost per unit</label>
                    <input type="text" readonly="readonly"  id="whatsappcostperunit" class="form-input">
                </div>
                <div class="flex flex-col gap-1">
                    <label class="text-default-800 text-sm font-medium inline-block">Quantity</label>
                    <input type="number" min="1" value="1"  name="whatsappqty" id="whatsappqty"  class="form-input">
                </div>
                <div class="flex flex-col gap-1">
                    <label class="text-default-800 text-sm font-medium inline-block">Total</label>
                    <input type="text" readonly="readonly" id="whatsapptotal"  class="form-input">
                </div>
            </div>
        </form>
