...
<script src="https://cdn.jsdelivr.net/npm/framer-motion@6.2.4/dist/framer-motion.min.js"></script>
                    ...
                    <ul class="admin-menu hs-accordion-group flex w-full flex-col gap-1">
                        ...
                        <li class="menu-item hs-accordion">
                            ...
                            <div class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300">
                                <ul class="mt-1 space-y-1">
                                    <li class="menu-item">
                                        <a data-navigo href="/sms/units" class='flex items-center gap-x-3.5 rounded-md px-3 py-1.5 text-sm font-medium text-default-400 transition-all hover:bg-default-100/5'>
                                            <i class="menu-dot"></i>
                                            <span class="menu-text">Sms Units</span>
                                        </a>
                                    </li>
                                    <li class="menu-item"> 
                                        <a data-navigo href="/whatsapp/units" class='flex items-center gap-x-3.5 rounded-md px-3 py-1.5 text-sm font-medium text-default-400 transition-all hover:bg-default-100/5'>
                                            <i class="menu-dot"></i>
                                            <span class="menu-text">Whatsapp Units</span>
                                        </a>
                                    </li> 
                        ...
                        <li class="menu-item hs-accordion">
                            <a href="javascript:void(0)"
                                ...
                                <span class="menu-text"> Engagements </span>
                                <span class="menu-arrow"></span>
                            </a>
                                ...
                                <ul class="mt-1 space-y-1">
                                    <li class="menu-item">
                                        <a data-navigo href="/campaign/option" class='flex items-center gap-x-3.5 rounded-md px-3 py-1.5 text-sm font-medium text-default-400 transition-all hover:bg-default-100/5'>
                                            <i class="menu-dot"></i>
                                            <span class="menu-text">Messaging Activity</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a data-navigo href="/campaign/managecampaign" class='flex items-center gap-x-3.5 rounded-md px-3 py-1.5 text-sm font-medium text-default-400 transition-all hover:bg-default-100/5'>
                                            <i class="menu-dot"></i>
                                            <span class="menu-text">Manage</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a data-navigo href="/campaign/templates" class='flex items-center gap-x-3.5 rounded-md px-3 py-1.5 text-sm font-medium text-default-400 transition-all hover:bg-default-100/5'>
                                            <i class="menu-dot"></i>
                        ...
                        <li class="menu-item">
                            <a data-navigo href="/main/conversations" class='group flex items-center gap-x-3.5 rounded-md px-3 py-2 text-sm font-medium text-default-400 transition-all hover:bg-default-100/5'>
                        ...
                        <li class="menu-item hs-accordion">
                            ...
                            <div class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300">
                                <ul class="mt-1 space-y-1">
                                    <li class="menu-item">
                                        <a data-navigo href="/unit/history" class='flex items-center gap-x-3.5 rounded-md px-3 py-1.5 text-sm font-medium text-default-400 transition-all hover:bg-default-100/5'>
                                            <i class="menu-dot"></i>
                                            <span class="menu-text">SMS Check History</span>
                                        </a>
                                    </li>
                                     <li class="menu-item">
                                        <a data-navigo href="/whatsappunit/history" class='flex items-center gap-x-3.5 rounded-md px-3 py-1.5 text-sm font-medium text-default-400 transition-all hover:bg-default-100/5'>
                                            <i class="menu-dot"></i>
                                            <span class="menu-text">Whatsapp Check History</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item hs-accordion">
                            ...
                            <div class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300">
                                <ul class="mt-1 space-y-1">
                                    <li class="menu-item">
                                        <a data-navigo href="/sms/packages" class='flex items-center gap-x-3.5 rounded-md px-3 py-1.5 text-sm font-medium text-default-400 transition-all hover:bg-default-100/5'>
                                            <i class="menu-dot"></i>
                                            <span class="menu-text">SMS Packages</span>
                                        </a>
                                    </li>
                                     <li class="menu-item">
                                        <a data-navigo href="/whatsapp/packages" class='flex items-center gap-x-3.5 rounded-md px-3 py-1.5 text-sm font-medium text-default-400 transition-all hover:bg-default-100/5'>
                                            <i class="menu-dot"></i>
                                            <span class="menu-text">Whatsapp Packages</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
