...
const routes = [
    ...
    { 
        path: '/whatsapp/units', 
        template: parseTemplateUrl('whatsappunit'), 
        script: parseScriptUrl('whatsappunit'),
        startFunction: 'whatsappUnitsActive',
    },
    { 
    ...
    { 
        path: '/campaign/setup/edit/whatsapp', 
        template: parseTemplateUrl('campaignsetup-3'),
        script: parseScriptUrl('campaignsetup-3'),
        startFunction: 'campaignSetup3Active',
    },
    { 
        path: '/campaign/setup/promotion', 
        template: parseTemplateUrl('campaignpromotionauto'),
        script: parseScriptUrl('campaignpromotionauto'),
        startFunction: 'campaignpromotionautoActive',
    },
    { 
        path: '/campaign/setup/prompt', 
        template: parseTemplateUrl('campaignautomated'),
        script: parseScriptUrl('campaignautomated'),
        startFunction: 'campaignautomatedActive',
    },
    { 
        path: '/campaign/managecampaign', 
        template: parseTemplateUrl('managecampaign'),
        script: parseScriptUrl('managecampaign'),
        startFunction: 'managecampaignActive',
    }, 
    { 
        path: '/campaign/transactional', 
        template: parseTemplateUrl('transactional'),
        script: parseScriptUrl('transactional'),
        startFunction: 'transactionalActive',
    },
    { 
        path: '/main/conversations', 
        template: parseTemplateUrl('conversations'),
        script: parseScriptUrl('conversations'),
        startFunction: 'conversationsActive',
    },
    { 
        path: '/sms/packages', 
        template: parseTemplateUrl('smspackages'),
        script: parseScriptUrl('smspackages'),
        startFunction: 'smspackagesActive',
    },
    { 
        path: '/whatsapp/packages', 
        template: parseTemplateUrl('whatsapppackages'),
        script: parseScriptUrl('whatsapppackages'),
        startFunction: 'whatsapppackagesActive',
    },
    { 
        path: '/unit/history', 
        template: parseTemplateUrl('unithistory'),
        script: parseScriptUrl('unithistory'),
        startFunction: 'unithistoryActive',
    },
      
      { 
        path: '/whatsappunit/history', 
        template: parseTemplateUrl('whatsappunithistory'),
        script: parseScriptUrl('whatsappunithistory'),
        startFunction: 'whatsappunithistoryActive',
    },
    { 
        path: '/campaign/templates',
        template: parseTemplateUrl('templates'),
        script: parseScriptUrl('templates'),
        startFunction: 'templatesActive',
    },
];
