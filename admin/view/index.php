...
<body>
    <main class="h-screen bg-primary/10">
        <div class="h-full">
            ...
            <!-- header -->
            <header>
                <div class="flex items-center bg-blue-800 border-b border-gray-200/50">
                    <span
                        class="xl:w-[250px] font-bold text-base block py-3 pl-5 selection:bg-white uppercase font-heebo text-white">Fintain<span
                    ...
                    <div class="flex-1 flex items-center justify-end xl:justify-between">
                        ...
                        <span class="px-1 order-first xl:order-last">
                            <button onclick="logoff()" title="logout" class="flex items-center justify-center h-7 w-7 rounded hover:bg-primary transition ease-linear duration-300 text-gray-200">
                        ...
                        <div class="overflow-y-auto overflow-x-hidden h-full">
                            <ul class="font-poppins mt-5">
                                ...
                                <li class="nav-item hidden">
                                    ...
                                    <ul class="ml-10 gap-y-4 flex flex-col">
                                        <li class="navitem-child" id="access_control">SMS Package</li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    <span class=" navitem-title group">
                                        <span class="material-symbols-outlined group-hover:text-primary-g"
                                            style="font-size: 20px;">money</span>
                                        <span class="group-hover:text-primary-g">
                                            <span>Payee</span>
                                            <span class="material-symbols-outlined" style="font-size: 15px;">chevron_right</span>
                                        </span>
                                    ...
                                    <ul class="ml-10 gap-y-4 flex flex-col">
                                        <li class="navitem-child" id="individual">Individual</li>
                                        <li class="navitem-child" id="company">Company</li>
                                    </ul>
                                </li>
