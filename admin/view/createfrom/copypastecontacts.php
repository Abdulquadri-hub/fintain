<div>
    <div class="mx-auto lg:w-4/5 2xl:w-3/5">
        <div class="flex items-center md:justify-between flex-wrap gap-2 mb-5">
            ...
            <p class="text-default-500 mb-10 mt-1">Copy your contacts and their information from a file and paste them into KreativeRock or type everything directly in the field. This is particularly useful when you have a small number of contacts to import.</p>
        </div>
                	...
                	<div>
                		<div class="flex flex-col lg:flex-row gap-3 lg:items-end lg:justify-between w-full pb-5">
                		    <div class="flex flex-col gap-2">
                		        ...
                		        <div>Copy and paste your contacts and their information from a file. Ensure you have created your segment <a href="https://comeandsee.com.ng/kreativerock/newadmin/view/contact/segment" class="text-blue-400 text-xs">Create Segment</a></div>
                		    </div>
                        ...
                        <div class="flex flex-col gap-1 mb-4">
                            ...
                            <select type="text" class="form-inputs" data-toggle="input-mask" name="segment_id" id="segment">
