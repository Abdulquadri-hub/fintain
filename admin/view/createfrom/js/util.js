...
async function createContact(button) {
    ...
    const request = await httpRequest('../../admin/controllers/contacts/create', payload, button)
...
async function fetchContactsGroup() {
    ...
    try {
        const request = await Promise.all([
            fetch('../../admin/controllers/contacts/fetch', { body: formContact, method: 'POST' }),
            fetch('../../admin/controllers/contacts/fetch', { body: importContact, method: 'POST' }),
            fetch('../../admin/controllers/contacts/fetch', { body: copyContact, method: 'POST' })
        ]);
