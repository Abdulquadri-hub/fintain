...
async function loadDashboardAnalytics() {
    let request = await httpRequest(`${baseurl}/dashboard/stats `, null, null)
    ...
    try {
        ...
        document.querySelector('[name="whatsappunits"]').innerHTML = data.whatsapp_unit_balance
        document.querySelector('[name="whatsappunitsspend"]').innerHTML = data.total_whatsappunit_spent
